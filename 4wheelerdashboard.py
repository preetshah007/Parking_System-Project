...
root=tk.Tk()
root.title("Car Parking Dashboard")
root.state('zoomed')
def backclick():
       subprocess.Popen(["python", "afterlogin.py"], shell=True)
def dailyrecord():
       subprocess.Popen(["notepad", "daily(4wheeler).txt"], shell=True)
def click(button):
        global hour
        global minute
        def printi():
        ...
        if button.cget("bg") == "red":
            ...
            time1=(f"{h1}:{m1}")
            with open("daily(4wheeler).txt", "r") as file:
                lines = file.readlines()
            with open("daily(4wheeler).txt", "w") as file:
                for line in lines:
            ...
            button.config(bg='SystemButtonFace')
                ...
                regi_e.insert(0, "AB:12:CD:3456")
                regi_e.place(x=850, y=255)
                def saving():
                        regie=regi_e.get()
                        tosave=(f"{button.cget('text')} - {regie} - {time}\n")
                        with open("daily(4wheeler).txt", "a") as file:
                                file.write(tosave)
                                file.flush()
...
tk.Label(root, text='Car Parking Allotment', font=("Bebas Neue", 22, "bold")).place(x=610, y=170)
b1=tk.Button(root,text="A1",width=7,height=3,command=lambda:click(b1))
b1.place(x=625,y=250)
b2=tk.Button(root,text="A2",width=7,height=3,command=lambda:click(b2))
b2.place(x=700,y=250)
b3=tk.Button(root,text="A3",width=7,height=3,command=lambda:click(b3))
b3.place(x=775,y=250)
b4=tk.Button(root,text="A4",width=7,height=3,command=lambda:click(b4))
b4.place(x=850,y=250)
b5=tk.Button(root,text="B1",width=7,height=3,command=lambda:click(b5))
b5.place(x=625,y=320)
b6=tk.Button(root,text="B2",width=7,height=3,command=lambda:click(b6))
b6.place(x=700,y=320)
b7=tk.Button(root,text="B3",width=7,height=3,command=lambda:click(b7))
b7.place(x=775,y=320)
b8=tk.Button(root,text="B4",width=7,height=3,command=lambda:click(b8))
b8.place(x=850,y=320)
b9=tk.Button(root,text="C1",width=7,height=3,command=lambda:click(b9))
b9.place(x=625,y=390)
b10=tk.Button(root,text="C2",width=7,height=3,command=lambda:click(b10))
b10.place(x=700,y=390)
b11=tk.Button(root,text="C3",width=7,height=3,command=lambda:click(b11))
b11.place(x=775,y=390)
b12=tk.Button(root,text="C4",width=7,height=3,command=lambda:click(b12))
b12.place(x=850,y=390)
b13=tk.Button(root,text="D1",width=7,height=3,command=lambda:click(b13))
b13.place(x=625,y=460)
b14=tk.Button(root,text="D2",width=7,height=3,command=lambda:click(b14))
b14.place(x=700,y=460)
b15=tk.Button(root,text="D3",width=7,height=3,command=lambda:click(b15))
b15.place(x=775,y=460)
b16=tk.Button(root,text="D4",width=7,height=3,command=lambda:click(b16))
...
daily4wheeler=tk.Button(root, text="Daily Records (4 Wheelers)", font=("Arial Black",10),width=22, height=2,bg="lightblue", command=dailyrecord).place(x=775, y=550)
root.mainloop()